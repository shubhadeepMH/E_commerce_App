            ...
            <div className=' p-2 lg:flex  flex-grow'>
                ...
                <div className='flex-grow' >
                    <div className="banner">
                        <img className='w-full h-80' src="https://cdn.colorexpertsbd.com/wp-content/uploads/2020/11/Banner-01-01-01.jpg" alt="" />
                ...
                {/* Right Bar */}
                <div className='bg-slate-200 mt-10 shadow-md relative bottm-0 shadow-black flex-grow flex-shrink lg:w-fit lg:mx-3 lg:mt-0'>
                 { basketItem.length!=0 &&  <div className=' p-2 lg:sticky lg:top-0'>
